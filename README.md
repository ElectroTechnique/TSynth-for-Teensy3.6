...
Compile using Teensy 3.6 at default 180MHz and set "Serial + MIDI + Audio" as an option. Compilation with overclocking (256MHz) and LTO options will make it use less "CPU" when running, but test fully.
