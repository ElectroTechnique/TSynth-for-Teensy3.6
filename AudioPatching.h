...
AudioSynthWaveformNewModulated waveformMod1b;  //xy=503,170
AudioSynthWaveformNewModulated waveformMod1a;  //xy=507,114
AudioSynthWaveformNewModulated waveformMod2b;  //xy=513,550
AudioSynthWaveformNewModulated waveformMod4a;  //xy=519,899
AudioSynthWaveformNewModulated waveformMod2a;  //xy=521,458
AudioSynthWaveformNewModulated waveformMod4b;  //xy=525,940
AudioSynthWaveformNewModulated waveformMod3a;  //xy=532,678
AudioSynthWaveformNewModulated waveformMod3b;  //xy=535,744
AudioSynthWaveformNewModulated waveformMod5a;  //xy=521,458
AudioSynthWaveformNewModulated waveformMod5b;  //xy=525,940
AudioSynthWaveformNewModulated waveformMod6a;  //xy=532,678
AudioSynthWaveformNewModulated waveformMod6b;  //xy=535,744
